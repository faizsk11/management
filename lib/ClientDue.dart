...
class ClientDueScreen extends StatefulWidget {
  const ClientDueScreen({Key? key}) : super(key: key);

  @override
  State<ClientDueScreen> createState() => _ClientDueScreenState();
}

class _ClientDueScreenState extends State<ClientDueScreen> {
  List<String> names = [
    'Aarav Agarwal',
    'Aditi Bhatnagar',
    'Arjun Chopra',
